...
export default function Social({ data, childSaveOnUnmount }: SocialProps) {
	...
	return (
		<Card>
			<CardTitle
				title="Links"
				hint="Optional — where people can follow the spot. Leave blank if there’s none."
			/>
	...
	function LinksInput({ svg, name, value, placeholder }, ref) {
		return (
			<div className="flex items-center gap-4 py-4 first:pt-0 last:pb-0">
				<div className="flex h-11 w-11 shrink-0 items-center justify-center rounded-xl bg-zinc-50 ring-1 ring-inset ring-zinc-200">
				...
				<div className="min-w-0 flex-1">
					...
					<input
						...
						className={cn(inputSkin, "max-w-lg")}
						ref={ref}
						defaultValue={value}
					/>
				</div>
